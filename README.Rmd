...
This files may be found in the directory titled Submission.
...
There are three ways to get this project on your computer.
...
knitr::include_graphics(here::here('images','rs-proj-wizard.png'))
```
